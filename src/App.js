  ...
  render() {
    return (
      ...
      />
        ...
        <Routes>
          <Route exact path="/" element={<News key={101}  setProgress={this.setProgress} firstload={this.state.firstload} title = {this.title} state={this.state} ref="child" category="general" coutryCode={this.state.coutryCode} fetchCountry={this.fetchCountry} codes={this.codes} cats={this.cats} countryChange={this.countryChange}  />} />
          {this.cats.map((value, index)=>{
            return <Route exact path={"/"+value} key={index} element={<News  title = {this.title} setProgress={this.setProgress} firstload={this.state.firstload} state={this.state} key={value} ref="child" category={value} coutryCode={this.state.coutryCode} fetchCountry={this.fetchCountry} codes={this.codes} cats={this.cats} countryChange={this.countryChange} />} />
          })}
        </Routes>
      </Router>
    )
